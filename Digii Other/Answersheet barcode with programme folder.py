...
# =========================================================
INPUT_FOLDER = r"C:\Users\suraj\OneDrive\Desktop\FASCM (25 UG) Even Sem 2025-2026"

OUTPUT_FOLDER = r"C:\Users\suraj\OneDrive\Desktop\OUTPUT_PDFS"
...
for excel_file in excel_files:
    ...
    try:
        ...
        # -----------------------------------------------------
        # CHECK PROGRAMME COLUMN
        # -----------------------------------------------------
        if "Programme" not in df.columns:
            print(f"❌ 'Programme' column not found in {excel_file}")
            continue
        ...
        # Handle empty values
        if programme_name == "" or programme_name.lower() == "nan":
            programme_name = "Unknown_Programme"

        # Remove invalid folder characters
        invalid_chars = ['\\', '/', ':', '*', '?', '"', '<', '>', '|']

        for char in invalid_chars:
            programme_name = programme_name.replace(char, "-")

        # -----------------------------------------------------
        # CREATE PROGRAMME FOLDER
        # -----------------------------------------------------
        programme_folder = os.path.join(
            OUTPUT_FOLDER,
            programme_name
        )

        os.makedirs(programme_folder, exist_ok=True)
        ...
        print(f"❌ Error processing {excel_file}")
        print(str(e))
